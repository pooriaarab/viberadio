...
Read `.agents/design.md` before changing CLI output, prototypes, or media.
...
```text
branch:  vr-<issue>-<slug>          vr-142-fix-onboarding-drop-off
title:   [VR-<issue>] <Subject>   [VR-142] Fix onboarding drop-off
body:    Closes #142
